      ...
      <div class="food-content">
        ...
        <div class="content">
          ...
          <div class="cartcontrol-wrapper">
            <cartcontrol @increase="addFood" :food="food"></cartcontrol>
          </div>
        ...
        <div class="rating">
          ...
          <ratingselect :selectType="selectType" @selected="selectRating" @toggled="toggleContent" :onlyContent="onlyContent" :desc="desc" :ratings="food.ratings"></ratingselect>
